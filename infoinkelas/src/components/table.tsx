...
function Tr({ id, title, description, duedate, status }){
    return(
        <tr className="bg-gray-50 text-center">
                    <td className="px-16 py-2 flex-row items-center">
                        <span className="text-center ml-2 font-semibold">{title || "Unknown"}</span>
                    </td>
                    ...
                    <td className="px-16 py-2">
                        <button className="cursor"><span className="bg-green-500 text-white px-5 py-1 rounded-md">{status || "Unknown"}</span></button>
                    </td>
